...
//
// Neither app has a component-test dependency and adding one is a decision of
...
// since these are the same primitives it wraps. Copied verbatim from plaid-igt;
// it moves into the shared package with the rest of the test kit in 0.2.
