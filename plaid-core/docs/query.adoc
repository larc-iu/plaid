...
layer name, alias, or `Project/Layer` path: names and aliases are non-unique across a
...
A non-ID reference (a name, alias, or path) is a 400. In practice this is no burden:
