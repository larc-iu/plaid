...
Who counts as a contributor is each app's decision: Plaid IGT treats a project's writers as contributors when the project's Access settings say writers' work is reviewed, and maintainers as verifiers.
