(ns plaid.rest-api.v1.error-status-mapping-test
  ...
  (`plaid.sql.dialect/retryable-conflict?`, shared with the batch endpoint) so a
...
;; ============================================================
;; BUG-C: d/retryable-conflict? unit
;; ============================================================

(deftest retryable-conflict?-walks-cause-and-suppressed
  (let [busy? d/retryable-conflict?]
