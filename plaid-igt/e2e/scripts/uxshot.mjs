...
//
// Usage:
//   node e2e/scripts/uxshot.mjs <documentId> <outPng> [--width=1400] [--height=900] \
//        [--tab=Analyze] [--full] [--wait=ms]
//
// Examples:
//   node e2e/scripts/uxshot.mjs 019ea... /tmp/igt-ux/a-analyze.png
//   node e2e/scripts/uxshot.mjs 019ea... /tmp/igt-ux/a-narrow.png --width=700
...
async function main() {
  ...
  if (!documentId || !outPng) {
    console.error(
      'usage: node e2e/scripts/uxshot.mjs <documentId> <outPng> [--width=] [--height=] [--tab=] [--full] [--wait=]',
    );
    process.exit(2);
  }
