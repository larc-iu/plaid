...
// alone. `vocab-num` on the number is the hook the e2e specs select it by,
// the React counterpart of the island's `igt-vocab__num`.
export const FormLabel = ({ form, index, className = '' }) => (
  <span className={className}>
    {form}
    {index ? (
      <span className="vocab-num ml-1 text-[0.85em] font-normal tabular-nums text-muted-foreground">
        {index}
      </span>
    ) : null}
  </span>
