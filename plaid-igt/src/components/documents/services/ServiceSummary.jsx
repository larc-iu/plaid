...
export const mdComponents = {
  ...
  h2: ({ node: _node, ...p }) => (
    <div style={{ fontWeight: 600, fontSize: '0.9rem', margin: '0.5em 0 0.2em' }} {...p} />
  ),
  h3: ({ node: _node, ...p }) => (
    <div style={{ fontWeight: 600, fontSize: '0.85rem', margin: '0.5em 0 0.2em' }} {...p} />
  ),
  p: ({ node: _node, ...p }) => <p style={{ margin: '0.4em 0' }} {...p} />,
  ul: ({ node: _node, ...p }) => (
    <ul style={{ margin: '0.3em 0', paddingLeft: '1.2em', listStyle: 'disc' }} {...p} />
  ),
  ...
  code: ({ node: _node, ...p }) => (
    <code style={{ background: 'rgba(0,0,0,0.06)', padding: '0 0.25em', borderRadius: 3 }} {...p} />
  ),
