...
from plaid_igt_agent.agent import ModelConfig, TurnCancelled, TurnResult
from plaid_igt_agent.conversation import ConversationStore, assistant_item, build_meta, user_item
...
def _seed(client, conv_id='c1', request_id='r1', text='Which words are unglossed?'):
    ...
    store = ConversationStore(client, 'u@x', 'p1')
