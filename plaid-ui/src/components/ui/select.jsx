...
// `hint` is a line under the option saying what choosing it means. It sits
// OUTSIDE `ItemText`, which is what the closed trigger renders, so the trigger
// keeps showing the name alone.
